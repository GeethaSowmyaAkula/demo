...
Be concise, operator-focused, and use markdown tables or bullet points for telemetry stats where appropriate. Always stay in character.`
        ...
        const reply = data.choices && data.choices[0] ? data.choices[0].message.content : "No response generated by Groq.";
        ...
        setCopilotMessages(prev => {
          const updated = [...prev];
          updated[updated.length - 1] = { role: 'ai', content: `Error communicating with Groq API: ${err.message}` };
          return updated;
        });
      }
    } else {
      ...
      setTimeout(() => {
        ...
        setCopilotMessages(prev => [...prev, { role: 'ai', content: responseText }]);
      }, 1000);
    }
  };
